...
gs = HalvingRandomSearchCV(estimator=pipe, param_distributions=param_grid, n_candidates='exhaust', 
                        resource='n_samples', factor=1.5, scoring='accuracy', cv=10, random_state=1, 
                        refit=True, n_jobs=-1)
