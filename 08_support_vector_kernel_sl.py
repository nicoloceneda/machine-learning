...
svmachine = SVC(gamma=0.2, C=1.0, random_state=1, kernel='rbf')
...
svmachine.fit(X_train_std, y_train)
...
y_predict = svmachine.predict(X_test_std)
...
plot_decision_regions(X=X_combined_std, y=y_combined, classifier=svmachine, test_idx=range(105, 150))
