...
gs = GridSearchCV(estimator=pipe, param_grid=param_grid, scoring='accuracy', cv=2, n_jobs=-1)
scores = cross_val_score(estimator=gs, X=X_train, y=y_train, scoring='accuracy', cv=5, n_jobs=-1)
